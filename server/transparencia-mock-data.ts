...
async function criarDadosAbrace() {
  ...
  const documentos = [
    {
      ...
      categoria: "legal" as const,
      organizacaoId,
      arquivoUrl: "/uploads/transparencia/abrace-estatuto.pdf",
      arquivoTipo: "application/pdf",
    ...
    },
    {
      ...
      categoria: "governanca" as const,
      organizacaoId,
      arquivoUrl: "/uploads/transparencia/abrace-ata-ago-2024.pdf",
      arquivoTipo: "application/pdf",
      arquivoTamanho: "1.5 MB",
      visibilidade: "publico" as const,
    ...
    },
    {
      ...
      categoria: "relatorios" as const,
      organizacaoId,
      arquivoUrl: "/uploads/transparencia/abrace-sustentabilidade-2023.pdf",
      arquivoTipo: "application/pdf",
    ...
    },
    {
      ...
      categoria: "governanca" as const,
      organizacaoId,
      arquivoUrl: "/uploads/transparencia/abrace-boas-praticas.pdf",
      arquivoTipo: "application/pdf",
    ...
    },
    {
      ...
      categoria: "governanca" as const,
      organizacaoId,
      arquivoUrl: "/uploads/transparencia/abrace-comite-cientifico.pdf",
      arquivoTipo: "application/pdf",
      arquivoTamanho: "2.1 MB",
      visibilidade: "publico" as const,
  ...
  const membros = [
    ...
    },
    {
      ...
      email: "rafael.oliveira@abrace.org.br",
      tipo: "diretoria" as const,
    ...
    {
      nome: "Carla Souza",
      email: "carla.souza@abrace.org.br",
      tipo: "diretoria" as const,
      cargo: "diretor_financeiro",
      organizacaoId,
    ...
    {
      nome: "Paulo Martins",
      email: "paulo.martins@abrace.org.br",
      tipo: "diretoria" as const,
    ...
    },
    {
      ...
      email: "lucia.carvalho@abrace.org.br",
      tipo: "conselho" as const,
    ...
    },
    {
      ...
      email: "ricardo.almeida@abrace.org.br",
      tipo: "conselho" as const,
      cargo: "conselheiro_cientifico",
      organizacaoId,
      dataIngresso: new Date("2021-05-20"),
