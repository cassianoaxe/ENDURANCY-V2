...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Rota dedicada para visualização de pré-cadastros (funciona tanto em dev quanto produção)
  app.get('/admin/pre-cadastros-view', (req, res) => {
    // Retornar página HTML diretamente na resposta
    res.send(`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
