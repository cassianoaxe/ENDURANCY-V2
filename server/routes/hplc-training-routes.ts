...
export const hplcTrainingRoutes = Router();
...
export async function registerHplcTrainingRoutes(app: Express) {
  ...
  // Registrar todas as rotas com prefixo adequado
  app.use('/api/laboratory/hplc', authenticate, checkHplcAccess, hplcTrainingRoutes);
  
  console.log('Rotas de treinamento HPLC registradas');
}
