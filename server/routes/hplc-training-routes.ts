...
// Função principal para registrar as rotas de treinamento HPLC
export async function registerHplcTrainingRoutes(app: Express) {
  ...
  // Middleware para garantir que as respostas sejam JSON
  const ensureJsonResponse = (req: Request, res: Response, next: Function) => {
    res.setHeader('Content-Type', 'application/json');
    next();
  };

  // Registrar diretamente as rotas na aplicação principal
  // GET all trainings
  app.get('/api/laboratory/hplc/trainings', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
  ...
  // GET training by ID
  app.get('/api/laboratory/hplc/trainings/:id', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
      const laboratoryId = req.session.user?.organizationId;
  ...
  app.post('/api/laboratory/hplc/trainings', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const {
        trainingTitle,
        trainingType,
  ...
  app.put('/api/laboratory/hplc/trainings/:id', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
      const {
        trainingTitle,
  ...
  app.delete('/api/laboratory/hplc/trainings/:id', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
      const laboratoryId = req.session.user?.organizationId;
  ...
  app.get('/api/laboratory/hplc/training-users', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const laboratoryId = req.session.user?.organizationId;
  ...
  app.get('/api/laboratory/hplc/training-procedures', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const laboratoryId = req.session.user?.organizationId;
  ...
  app.get('/api/laboratory/hplc/training-equipments', authenticate, checkHplcAccess, ensureJsonResponse, async (req: Request, res: Response) => {
    try {
      const laboratoryId = req.session.user?.organizationId;
  ...
  console.log('Rotas de treinamento HPLC registradas diretamente');
}

// GET all trainings with optional filters
hplcTrainingRoutes.get('/trainings', async (req: Request, res: Response) => {
  try {
    const { status, search } = req.query;
    const laboratoryId = req.session.user?.organizationId;
...
hplcTrainingRoutes.get('/trainings/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const laboratoryId = req.session.user?.organizationId;
...
// POST create a new training
hplcTrainingRoutes.post('/trainings', async (req: Request, res: Response) => {
  try {
    const {
      trainingTitle,
      trainingType,
...
hplcTrainingRoutes.put('/trainings/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const {
      trainingTitle,
...
// DELETE a training
hplcTrainingRoutes.delete('/trainings/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const laboratoryId = req.session.user?.organizationId;
...
// GET users available for training
hplcTrainingRoutes.get('/training-users', async (req: Request, res: Response) => {
  try {
    const laboratoryId = req.session.user?.organizationId;
...
// GET procedures available for training
hplcTrainingRoutes.get('/training-procedures', async (req: Request, res: Response) => {
  try {
    const laboratoryId = req.session.user?.organizationId;
...
// GET equipments available for training
hplcTrainingRoutes.get('/training-equipments', async (req: Request, res: Response) => {
  try {
    const laboratoryId = req.session.user?.organizationId;
...
export default hplcTrainingRoutes;