...
export default function PreCadastrosPublico() {
  ...
  // Definição das colunas para a tabela (modo somente leitura)
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">Visualização de Pré-cadastros</h1>
          <p className="text-muted-foreground">
            Pré-cadastros recebidos para o lançamento do sistema (Versão Pública)
          </p>
        </div>
