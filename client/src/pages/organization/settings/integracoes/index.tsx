...
const integracoes: Integracao[] = [
  {
    ...
    configuracaoUrl: '/organization/settings/integracoes/contaazul',
  },
  {
    id: 'nfse',
    nome: 'Emissor NFSe',
    ...
    configuracaoUrl: '/organization/settings/integracoes/nfse',
  },
  {
    id: 'nfe',
    nome: 'Emissor NFe',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/nfe',
  },
  {
    id: 'ecommerce-woo',
    nome: 'WooCommerce',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/woocommerce',
  },
  {
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/shopify',
  },
  {
    id: 'mailchimp',
    nome: 'Mailchimp',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/mailchimp',
  },
  {
    id: 'pipefy',
    nome: 'Pipefy',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/pipefy',
  },
  {
    id: 'magento',
    nome: 'Magento',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/magento',
  },
  {
    id: 'totvs',
    nome: 'TOTVS',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/totvs',
  },
  {
    id: 'rdstation',
    nome: 'RD Station',
    ...
    status: 'inativa',
    configuracaoUrl: '/organization/settings/integracoes/rdstation',
  }
];
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Conecte o sistema com outros serviços e plataformas</p>
      </div>
