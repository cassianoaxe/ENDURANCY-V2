...
type TipoIntegracao = 'contabilidade' | 'erp' | 'crm' | 'ecommerce' | 'marketing' | 'comunicacao' | 'logistica';
...
// Combinando as integrações do ComplyPay com as da página de configurações
const integracoes: Integracao[] = [
  // Integrações do ComplyPay
  {
    id: 'contaazul',
    nome: 'ContaAzul',
  ...
  // Integrações da página de configurações
  {
    id: 'complychat',
    nome: 'COMPLYCHAT',
    descricao: 'Integração com canal de chat para comunicação interna e externa',
    tipo: 'comunicacao',
    logoUrl: '',
    status: 'ativa',
    configuracaoUrl: '/organization/integracoes/complychat',
    icon: <MessageSquare size={24} className="text-primary" />
  },
  {
    id: 'whatsapp',
    nome: 'WHATSAPP',
    descricao: 'Envie mensagens automáticas e notificações para pacientes e clientes',
    tipo: 'comunicacao',
    logoUrl: '',
    status: 'inativa',
    configuracaoUrl: '/organization/integracoes/whatsapp',
    icon: <MessageSquare size={24} className="text-primary" />
  },
  {
    id: 'melhor-envio',
    nome: 'MELHOR ENVIO',
    descricao: 'Calcule fretes e gerencie envios com as principais transportadoras',
    tipo: 'logistica',
    logoUrl: '',
    status: 'inativa',
    configuracaoUrl: '/organization/integracoes/melhor-envio',
    icon: <Send size={24} className="text-primary" />
  },
  {
    id: 'azul-cargo',
    nome: 'AZUL CARGO',
    descricao: 'Integração direta com a Azul Cargo para envios aéreos rápidos',
    tipo: 'logistica',
    logoUrl: '',
    status: 'inativa',
    configuracaoUrl: '/organization/integracoes/azul-cargo',
    icon: <Plane size={24} className="text-primary" />
  },
  {
    id: 'correios',
    nome: 'CORREIOS',
    descricao: 'Integração com os Correios para cálculo de fretes e rastreamento',
    tipo: 'logistica',
    logoUrl: '',
    status: 'inativa',
    configuracaoUrl: '/organization/integracoes/correios',
