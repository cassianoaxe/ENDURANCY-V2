...
interface User {
  id: number;
  username: string;
  role: 'admin' | 'org_admin' | 'doctor' | 'patient' | 'pharmacist' | 'laboratory' | 'researcher' | 'complypay';
  name: string;
  email: string;
...
interface AuthContextType {
  ...
  isLoading: boolean;
  login: (username: string, password: string, userType?: 'admin' | 'org_admin' | 'doctor' | 'patient' | 'pharmacist' | 'laboratory' | 'researcher' | 'complypay', orgCode?: string) => Promise<void>;
  logout: () => void;
}
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = async (username: string, password: string, userType?: 'admin' | 'org_admin' | 'doctor' | 'patient' | 'pharmacist' | 'laboratory' | 'researcher' | 'complypay', orgCode?: string) => {
    setIsLoading(true);
    try {
